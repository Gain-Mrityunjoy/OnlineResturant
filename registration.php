...
if(isset($_POST['submit'] )) 
{
	...
	$mql = "INSERT INTO users(username,name,email,phone,password,address) VALUES('".$_POST['username']."','".$_POST['name']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."')";
	mysqli_query($db, $mql);
                     ...
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>129, Sarkit House, Dak Bangla, Khulna, Bangladesh</p>
                                    <h5>Phone:  8093424562</a></h5> </div>
                                </div>
                        </div>
                     </div>
                  </div>
